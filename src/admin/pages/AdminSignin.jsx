...
export const AdminSignin = () => {
    ...
    async function LogInUser(e) {
        e.preventDefault()
        try {
            const result = await fetch("https://wowcakebackend.onrender.com/api/admin/signin", {
                method: 'POST',
                headers: {
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className='flex  items-center '>
                        ...
                        <div className='text-center  ml-20 md:ml-40 '>
                            ...
                            <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900"> Admin Sign In </h2>
                        </div>
