                ...
                <div className='max-w-screen-lg  mx-auto flex flex-col justify-center w-full h-full  '>
                    ...
                    <div className="grid gap-10 grid-cols-2 lg:grid-cols-4 md:grid-cols-3 px-4 ">
                        {TrendingCakesData1.map(data => {
                            return (
                                <div key={data.id} className="bg-white md:w-52  md:h-60   rounded-lg  shadow-lg hover:border-amber-400 hover:border-4 duration-400 ease-in-out items-center hover:scale-110 duration-500 ">
